      ...
      <section className="min-h-screen w-full py-12 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-zinc-900 dark:to-zinc-800 flex items-center justify-center">
        <div className="hidden md:block">
          ...
          <p className="mt-4 text-center text-black dark:text-white">
            Choose the right plan for your team. All plans include a 7-day free
            trial.
          </p>
        </div>
        <div className=" px-4 md:px-6">
          <div className="grid grid-cols-1 gap-6 mt-8 lg:grid-cols-3 md:gap-8">
            <div className=" md:hidden">
              ...
              <p className="mt-4 text-center text-black dark:text-white">
                Choose the right plan for your team. All plans include a 7-day
                free trial.
              </p>
            </div>
            ...
            <div className="relative flex flex-col p-6 bg-white shadow-lg rounded-lg dark:bg-zinc-850 justify-between border border-purple-500 dark:border-gray-800">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2 text-black">
                  <li className="flex items-center">
                    <CheckIcon className="text-black text-2xs bg-green-500 rounded-full mr-2 p-1" />
